...
struct
  ...
  let test_custom_comparator_non_datum db =
    ...
    let alt x y = alt x y; agt y x; aeq ~rev x y in
      ...
      alt "1\001\001d\000\000\000\000\000\000\000\128\001\000\009\t\000\000"
          "1\001\001dd%d]\000\000V\251\255\001\001\009\t\000\000";
      (* diff timestamps, but nonetheless equal datum_keys *)
      aeq
        "1\001\001dd\212<\015\017\254U\251\255\001\001\009\t\000\000"
        "1\001\001dd\135;\015\017\254U\251\255\001\001\009\t\000\000";
      (* unrelated keys *)
      alt
        "1\001\001cc\187\215\205\226\253U\251\255\001\001\009\t\000\000"
        "1\001\001dd@\214\205\226\253U\251\255\001\001\009\t\000\000";
      return ()
